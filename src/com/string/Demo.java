...
public class Demo {
    ...
    private static Character findLastNonRepeatingCharacter(String string) {
        ...
        for (int i = 0; i < string.length(); i++) {
            ...
            if (characterMap.containsKey(currentCharacter)) {  characterMap.put(currentCharacter, characterMap.get(currentCharacter) + 1); } else { //character is not added to the map. add it with value as 1 characterMap.put(currentCharacter, 1); } } for (int i = string.length() - 1; i >= 0; i--) {
